    ...
    questions: [
        {
            ...
            question: '전체 집행률이 계획 대비 낮은 편이네요. 특히 용역비 집행이 아직 없는데, 사유와 향후 계획을 설명해 주실 수 있을까요?',
            answers: [
                {
                    text: '용역 과업범위 조정으로 계약이 지연되어 집행률이 낮습니다. 하반기 계약 일정과 집행계획을 정리해 설명드리겠습니다.',
                    correct: true
                },
        ...
        },
        {
            ...
            question: '용역비가 아직 집행되지 않았네요. 현재 추진 상황은 어떻게 되나요?',
            answers: [
                {
                    text: '제안요청서와 과업 범위를 검토 중이며, 계약 절차 진행 후 일정에 따라 집행할 예정입니다.',
                    correct: true
                },
                { text: '아직 필요 없어서 안했습니다.', correct: false },
        ...
        },
        {
            ...
            question: '사업추진비 집행이 꽤 진행됐네요. 회의 관련 증빙은 정리되어 있나요?',
            answers: [
                { text: '회의록, 참석자 명단, 지출 증빙을 회의별로 정리해두겠습니다.', correct: true },
        ...
        },
        {
            ...
            question: '장비 구매가 있었네요. 자산등록 상태도 확인되어 있나요?',
            answers: [
                { text: '구매 증빙과 함께 PIMS 자산등록 내역을 확인해두겠습니다.', correct: true },
                { text: '영수증이 있으니 자산등록은 없어도 되지 않나요?', correct: false },
                { text: '담당자가 쓰고 있으니 따로 관리하지 않아도 됩니다.', correct: false },
        ...
        },
        {
            ...
            question: '당초 계획보다 일정이 늦어진 부분이 있어 보입니다. 향후 일정은 정리되어 있나요?',
            answers: [
                { text: '지연 사유와 변경된 추진 일정, 향후 보완계획을 정리해 설명드리겠습니다.', correct: true },
            ...
            correctFeedback: '좋습니다. 실태점검에서는 지연 여부뿐 아니라 향후 회복 계획도 함께 확인합니다.',
            wrongFeedback: '사업 일정이 지연되는 경우에는 지연 사유와 변경 일정, 향후 보완계획을 설명할 수 있어야 합니다.'
        },
        {
            id: 'audit_firm',
            speaker: '회계법인 회계사',
            ...
            question: '집행내역과 증빙자료를 확인하겠습니다. 어떤 자료를 준비해 주실 수 있을까요?',
            answers: [
